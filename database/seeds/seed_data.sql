...
INSERT INTO countries
  (country_code, country_name, region, capital, currency, language, population,
   power_voltage, timezone, tipping, climate, description, flag, advisory_level,
   visa_status, cdc_notice_level, places)
VALUES
...
VALUES
  ('RW', 'Rwanda',
   ...
   ARRAY['Malaria', 'Typhoid', 'Hepatitis A', 'Waterborne diseases'],
   ARRAY[]::TEXT[],
  ...
  ('KE', 'Kenya',
   ...
   ARRAY['Malaria', 'Typhoid', 'Rabies', 'Waterborne diseases', 'Dengue Fever'],
   ARRAY[]::TEXT[],
  ...
  ('ZA', 'South Africa',
   ...
   ARRAY['Malaria (northern border areas)', 'HIV/AIDS', 'Waterborne diseases in rural areas'],
   ARRAY[]::TEXT[],
  ...
  ('MA', 'Morocco',
   ...
   ARRAY['Waterborne diseases', 'Food-borne illness', 'Sandfly fever'],
   ARRAY[]::TEXT[],
  ...
  ('TZ', 'Tanzania',
   ARRAY['Yellow Fever (if arriving from endemic country)'],
   ARRAY['Hepatitis A', 'Typhoid', 'Malaria prophylaxis', 'Rabies', 'Meningitis', 'Cholera'],
   ARRAY['Malaria', 'Typhoid', 'Schistosomiasis', 'Waterborne diseases', 'Rabies'],
   ARRAY[]::TEXT[],
  ...
  ('UG', 'Uganda',
   ARRAY['Yellow Fever'],
   ARRAY['Hepatitis A', 'Typhoid', 'Malaria prophylaxis', 'Rabies', 'Meningitis', 'Cholera'],
   ARRAY['Malaria', 'Typhoid', 'Ebola (border regions)', 'Waterborne diseases'],
   ARRAY[]::TEXT[],
  ...
  ('NG', 'Nigeria',
   ...
   ARRAY['Malaria', 'Typhoid', 'Lassa Fever', 'Cholera', 'Waterborne diseases', 'Monkey Pox'],
   ARRAY[]::TEXT[],
  ...
  ('GH', 'Ghana',
   ...
   ARRAY['Malaria', 'Typhoid', 'Waterborne diseases', 'Cholera'],
   ARRAY[]::TEXT[],
  ...
  ('ET', 'Ethiopia',
   ARRAY['Yellow Fever (if arriving from endemic country)'],
   ARRAY['Hepatitis A', 'Typhoid', 'Malaria prophylaxis', 'Rabies', 'Meningitis', 'Cholera'],
   ARRAY['Malaria (below 2000m)', 'Typhoid', 'Waterborne diseases', 'Altitude sickness'],
   ARRAY[]::TEXT[],
  ...
  ('SN', 'Senegal',
   ARRAY['Yellow Fever'],
   ARRAY['Hepatitis A', 'Typhoid', 'Malaria prophylaxis', 'Meningitis', 'Rabies', 'Cholera'],
   ARRAY['Malaria', 'Typhoid', 'Waterborne diseases', 'Dengue Fever'],
   ARRAY[]::TEXT[],
