...
/* ── ICONS ── */
const IC = {
  cap:   '<i class="fa-solid fa-landmark"></i>',
  money: '<i class="fa-solid fa-coins"></i>',
  lang:  '<i class="fa-solid fa-language"></i>',
  pop:   '<i class="fa-solid fa-users"></i>',
  plug:  '<i class="fa-solid fa-plug-circle-bolt"></i>',
  clock: '<i class="fa-solid fa-clock"></i>',
  tip:   '<i class="fa-solid fa-hand-holding-dollar"></i>',
  temp:  '<i class="fa-solid fa-cloud-sun"></i>',
  pass:  '<i class="fa-solid fa-passport"></i>',
  chk:   '<i class="fa-solid fa-check-circle"></i>',
  x:     '<i class="fa-solid fa-times-circle"></i>',
  warn:  '<i class="fa-solid fa-triangle-exclamation"></i>',
  syr:   '<i class="fa-solid fa-syringe"></i>',
  shld:  '<i class="fa-solid fa-shield-halved"></i>',
  pol:   '<i class="fa-solid fa-building-shield"></i>',
  amb:   '<i class="fa-solid fa-truck-medical"></i>',
  fire:  '<i class="fa-solid fa-fire-extinguisher"></i>',
  sos:   '<i class="fa-solid fa-phone-volume"></i>',
};
  ...
  const bulletHtml = bullets.length
    ? `<ul class="ai-highlights-list">
        ${bullets.slice(0, 6).map(b => `
          <li>
            <div class="ai-h-ico"><i class="fa-solid fa-sparkles"></i></div>
  ...
  setEl('d-ai', `
    <div class="ai-enhanced-card">
      <div class="ai-card-header">
        ...
        <div class="ai-header-txt">
          <div class="ai-title">AI Smart Overview</div>
          <div class="ai-subtitle">Insights for ${escapeHtml(name)}</div>
        </div>
      </div>
      <div class="ai-card-body">
        <div class="ai-prose">${paraHtml}</div>
        ${bulletHtml}
      </div>
      <div class="ai-card-footer">
        <i class="fa-solid fa-circle-info"></i> Generated by KBYG AI Assistant
      </div>
    </div>
  `);
}
